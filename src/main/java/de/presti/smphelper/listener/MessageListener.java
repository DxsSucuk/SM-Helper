...
public class MessageListener extends ListenerAdapter {
    ...
    public void onMessageReceived(@NotNull MessageReceivedEvent event) {
        ...
        if (!event.isWebhookMessage() && !event.getAuthor().isBot() && event.getChannel().getType() == ChannelType.TEXT && event.getChannel().asTextChannel().getParentCategoryIdLong() == Main.getRespondToMessageCategory() && event.getChannel().canTalk()) {
